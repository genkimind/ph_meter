...
static const char *TAG2 = "PH monitor";
...
void app_main(void)
{
    ...
    wifi_init_sta();
    ESP_LOGI(TAG, "DONE WIFI INIT NOW CREATING TASK");

    TaskHandle_t ph_handle = NULL;
    xTaskCreate(monitor_ph, "Monitor PH", 2000, NULL, 1, &ph_handle);
}
////////////////////////////////////////////////////
